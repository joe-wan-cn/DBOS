Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/hcheck_pdb.sql /main/1 2020/12/07 21:06:51 bvongray Exp $
Rem
Rem hcheck_pdb.sql
Rem
...
Rem    DESCRIPTION:
Rem      Doc ID 136697.1
Rem      To provide a single plsql which looks for common data dictionary
Rem      problems.
...
Rem        SQL> @hcheck
Rem
Rem      Must be executed in SYS schema
Rem      This script is intended for use in Oracle releases 10.2.0.5 onwards
Rem      This script will NOT work in 10.2.0.4 or earlier.
Rem      In all cases any output reporting "problems" should be
Rem      parsed by Oracle Support to confirm if any action is required.
Rem
Rem      About the Result Status:
Rem          CRITICAL:  Is of highest risk and require urgent fix.
Rem          FAIL:      Require resolution on priority.
Rem          WARN:      Good to resolve.
Rem          PASS:      No problem.
Rem
Rem    MODIFIED   (MM/DD/YY)
Rem    bvongray    11/06/20 - Created
Rem
...
-- For multitenant.  Run in PDB. 

column name new_value pdb_name
