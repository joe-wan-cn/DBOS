Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/util_planx.sql /main/1 2021/03/24 11:11:29 bvongray Exp $
Rem
Rem util_planx.sql
Rem
...
Rem
Rem    NAME
Rem      util_planx.sql -  Reports Execution Plans for one SQL_ID from RAC and AWR(opt)
Rem
Rem    DESCRIPTION
Rem       This script inputs two parameters. Parameter 1 is a flag to specify if
Rem         your database is licensed to use the Oracle Diagnostics Pack or not.
Rem         Parameter 2 specifies the SQL_ID for which you want to report all
Rem         execution plans from all nodes, plus all plans from AWR.
Rem         If you don't have the Oracle Diagnostics Pack license, or if you want
Rem           to omit the AWR portion then specify "N" on Parameter 1.
Rem
Rem    NOTES
Rem      Usage: @planx.sql Y f995z9antmhxn
Rem
Rem    BEGIN SQL_FILE_METADATA
Rem    SQL_SOURCE_FILE: tfa/src/v2/tfa_home/resources/sql/util_planx.sql
...
Rem    bvongray    03/16/21 - SQLHC version update
Rem    bvongray    03/16/21 - Created
Rem
