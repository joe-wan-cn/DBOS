Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/dataguard_logical_standby.sql /main/2 2021/12/13 07:46:12 bvongray Exp $
Rem
Rem dataguard_logical_standby.sql
Rem
...
Rem
Rem    DESCRIPTION
Rem       Collects dataguard logical standby Database information
Rem    NOTES:
Rem       ollects dataguard logical standby Database information
Rem
Rem    MODIFIED   (MM/DD/YY)
Rem    bvongray    11/15/21 - modify to allow passing of spoolfile name
Rem    bvongray    10/14/21 - Created
Rem
...
select '+----------------------------------------------------+' from dual 
union all 
select '| Script version:  '||'14-Sep-2021' from dual
union all
