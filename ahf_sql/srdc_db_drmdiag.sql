Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/srdc_db_drmdiag.sql /main/1 2021/03/24 11:11:30 bvongray Exp $
Rem
Rem srdc_db_drmdiag.sql
Rem
...
Rem
Rem    DESCRIPTION
Rem      This script is intended to provide a user friendly guide to troubleshoot
Rem       drm (dynamic resource remastering) waits. The script will create a file
Rem       called drmdiag_<timestamp>.out in your local directory.
Rem
Rem    NOTES
Rem     . 
Rem
Rem    BEGIN SQL_FILE_METADATA
Rem    SQL_SOURCE_FILE: tfa/src/v2/tfa_home/resources/sql/srdc_db_drmdiag.sql
