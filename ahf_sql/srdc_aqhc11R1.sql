Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/srdc_aqhc11R1.sql /main/4 2020/12/07 21:06:51 bvongray Exp $
Rem
Rem srdc_aqhc11R1.sql
Rem
...
Rem    SQL_SOURCE_FILE: tfa/src/v2/tfa_home/resources/sql/srdc_aqhc11R1.sql
...
REM
REM This healthcheck script version 6.0 is for use on the following Oracle database only.
REM     Oracle 11gR1
REM
REM Do not use this script on Oracle 10g configurations.
REM
REM
...
prompt Statistics : <a href="#Qstats">Queues</a> <a href="#Pubstats">Publishers</a> <a href="#substats">Subscribers</a> <a href="#subprop">Propagation</a> <a href="#Notifstats">Notifications</a> 
