Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/dataguard_primary.sql /main/3 2022/06/16 16:16:54 smuthuku Exp $
Rem
Rem dataguard_primary.sql 
Rem
...
Rem
Rem    DESCRIPTION
Rem       Collects dataguard Primary Database information
Rem    NOTES:
Rem       ollects dataguard Primary Database information
Rem
Rem    MODIFIED   (MM/DD/YY)
Rem    smuthuku    05/23/22 - Add sql to get the online redo log file location 
