Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/srdc_db_lfsdiag.sql /main/2 2022/03/09 20:24:41 bvongray Exp $
Rem
Rem srdc_db_lfsdiag.sql
Rem
Rem Copyright (c) 2017, 2022, Oracle and/or its affiliates. 
Rem All rights reserved.
Rem
Rem    NAME
Rem      srdc_db_lfsdiag.sql - <one-line expansion of the name>
Rem
Rem    DESCRIPTION
...
Rem    SQL_SOURCE_FILE: tfa/src/v2/tfa_home/resources/sql/srdc_db_lfsdiag.sql
...
Rem    bvongray    03/02/22 - update formatting
Rem    recornej    07/26/17 - Created
Rem
