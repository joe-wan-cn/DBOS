Rem
Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/fa_sqlhc_sta.sql /main/1 2022/07/05 20:13:23 smuthuku Exp $
Rem
Rem sqlhc_sta.sql
Rem
...
REM   2. Execute script fa_sqlhc.sql passing values for parameters.
REM
REM EXAMPLE
REM   # sqlplus / as sysdba
REM   SQL> START [path]fa_sqlhc_sta.sql [T|D|N] [SQL_ID]
REM   SQL> START fa_sqlhc_sta.sql T 51x6yr9ym5hdc
REM
REM   or
REM
REM   SQL> START fa_sqlhc_sta.sql T 51x6yr9ym5hdc
