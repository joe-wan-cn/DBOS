Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/srdc_xdbusagecheck.sql /main/1 2021/10/12 12:46:51 bvongray Exp $
Rem
Rem srdc_xdbusagecheck.sql
Rem
Rem Copyright (c) 2021, Oracle and/or its affiliates. 
Rem
Rem    NAME
Rem      srdc_xdbusagecheck.sql - Oracle XML Database Check
Rem
Rem    DESCRIPTION
Rem      This script will provide output to show which features of
Rem      XML Database (XDB) are currently being utilized in the database.
Rem
Rem    NOTES
Rem      .
Rem
Rem    MODIFIED   (MM/DD/YY)
Rem    bvongray    09/24/21 - .
Rem    bvongray    09/24/21 - Created
Rem

@@?/rdbms/admin/sqlsessstart.sql

define SRDCNAME='XDB_USAGE_CHECK'
