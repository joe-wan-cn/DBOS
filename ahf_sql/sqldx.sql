Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/sqldx.sql /main/2 2021/03/24 11:11:29 bvongray Exp $
Rem
REM
...
PRO REM $Header: tfa/src/v2/tfa_home/resources/sql/sqldx.sql /main/2 2021/03/24 11:11:29 bvongray Exp $
...
DECLARE
  ...
  BEGIN
    put_line('PRO <html>');
    put_line('PRO <!-- $Header: tfa/src/v2/tfa_home/resources/sql/sqldx.sql /main/2 2021/03/24 11:11:29 bvongray Exp $ -->');
    put_line('PRO <!-- Copyright (c) 2000-2013, Oracle Corporation. All rights reserved. -->');
    put_line('PRO <!-- Author: Carlos Sierra -->');
    put_line('PRO');
    put_line('PRO <head>');
